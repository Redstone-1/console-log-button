...
describe('buttonLog is gradient', () => {
  ...
  test("buttonLog.orangeLinearGradient", () => {
  ...
  test("buttonLog.yellowLinearGradient", () => {
  ...
  test("buttonLog.greenLinearGradient", () => {
  ...
  test("buttonLog.cyanLinearGradient", () => {
  ...
  test("buttonLog.blueLinearGradient", () => {
  ...
  test("buttonLog.purpleLinearGradient", () => {
